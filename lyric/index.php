		...
		<div class="jumbotron container pos2">
			<div class=" container ">
				<?php
			      ...
			      $db = "use lyric";
			      $conn->query($db);
			      $sql = "SELECT * FROM `front_page` ORDER BY `Time` DESC ";
			      ...
			      if ($result->num_rows > 0 ) {
			          while($row = $result->fetch_assoc() and $i>0 ) {
			            	...
			            	echo '<div class="col-sm-6 col-md-4 col-lg-4 col-xl-3 text-center "><br><a href="L/'.$fname.'.html"><img class="rounded shadow " src="img/' .$row["Image"]. '" width="150" height="150" ><br> ' . $row["Name"]. "</a><br>";
